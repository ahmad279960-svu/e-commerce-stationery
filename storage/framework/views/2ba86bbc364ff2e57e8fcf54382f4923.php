 ...
 <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?php echo e(route('admin.dashbord')); ?>" class="logo d-flex align-items-center">
...
<?php /**PATH D:\projects laravel\e-commerce-stationery\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>
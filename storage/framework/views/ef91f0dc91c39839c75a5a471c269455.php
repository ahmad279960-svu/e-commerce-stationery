        ...
        <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
            ...
            <div class="datatable-search">
                <form action="<?php echo e(route('user.index')); ?>" method="GET">
                    <button type="button" onclick="window.location.href='<?php echo e(route("user.index")); ?>'" class="btn btn-default btn-sm">Reset</button>
            ...
            <table class="table datatable datatable-table">
             ...
             <tbody>
                ...
                <tr data-index="0">
                    ...
                    <td>
                        <a href="#"  onclick="deleteUser(<?php echo e($user->id); ?>)" class="text-danger w-4 h-4 mr-1">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects laravel\e-commerce-stationery\resources\views/admin/user/list.blade.php ENDPATH**/ ?>
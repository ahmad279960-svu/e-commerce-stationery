...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/styleuser.css')); ?>">
...
<body>
    ...
    <?php if(!isset($excludeSection) || $excludeSection !== 'footer'): ?>
    ...
    <script>
        ...
        function addToWishlist(id) {
            ...
            $.ajax({
                url: '<?php echo e(route("account.addWishlist")); ?>',
                type: 'post',
                data: { id: id },
                datatype: 'json',
                success: function (response) {
...
</html><?php /**PATH D:\projects laravel\e-commerce-stationery\resources\views/user/layouts/app.blade.php ENDPATH**/ ?>
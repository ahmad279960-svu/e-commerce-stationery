            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action=" <?php echo e(route('processRegister')); ?>" method="POST" class="row g-3 needs-validation" id="registrationForm" name="registrationForm" >
                    ...
                    <div class="col-12">
                        <p class="small mb-0">I have account? <a href="<?php echo e(route('login')); ?>">Login now</a></p>
                    </div>
                  </form>
...
</html><?php /**PATH D:\projects laravel\e-commerce-stationery\resources\views/auth/register.blade.php ENDPATH**/ ?>
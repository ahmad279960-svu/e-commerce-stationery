        ...
        <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
            ...
            <div class="datatable-search">
                ...
                <form action="<?php echo e(route('category.index')); ?>" method="GET">
                        <button type="button" onclick="window.location.href='<?php echo e(route("category.index")); ?>'" class="btn btn-default btn-sm">Reset</button>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects laravel\e-commerce-stationery\resources\views/admin/Category/list.blade.php ENDPATH**/ ?>